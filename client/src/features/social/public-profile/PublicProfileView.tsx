      ...
      <main className="flex-1 container mx-auto px-4 py-8 max-w-md animate-in fade-in slide-in-from-bottom-4 duration-700">
        {isLoading ? (
          <div className="flex flex-col items-center justify-center py-20 text-gray-400">
            ...
            <p className="text-xl font-medium tracking-tight" style={{ fontFamily: "'Bebas Neue', sans-serif" }}>Scouting the spot...</p>
          </div>
        ) : error === "notFound" || !profile ? (
          <div className="flex flex-col items-center justify-center py-20 text-center">
            <UserX className="w-16 h-16 text-neutral-800 mb-4" />
            <h2 className="text-2xl font-black text-white mb-2" style={{ fontFamily: "'Bebas Neue', sans-serif" }}>Spot Unknown</h2>
            <p className="text-neutral-500 mb-8 max-w-[200px] mx-auto text-sm">Wood not found. This skater hasn't dropped a pin in our system yet.</p>
            <Link href="/">
          ...
          <div className="space-y-6">
            ...
            <Card className="bg-neutral-900/50 border-neutral-800/50 overflow-hidden shadow-2xl backdrop-blur-sm relative">
              ...
              <CardContent className="p-8">
                <div className="flex flex-col items-center text-center">
                  ...
                  <div>
                    <h1 className="text-4xl font-black text-white tracking-tighter" style={{ fontFamily: "'Bebas Neue', sans-serif" }}>
                      @{username}
                    </h1>
                    <div className="flex items-center justify-center gap-2 mt-2">
                      <Badge variant="outline" className="bg-neutral-900/50 text-neutral-400 border-neutral-800 uppercase text-[10px] font-bold tracking-widest px-3">
            ...
            <div className="flex flex-col items-center py-4 text-center">
              <div className="bg-neutral-900/50 px-4 py-2 rounded-full border border-neutral-800/50 mb-4 inline-flex items-center gap-2 shadow-sm">
                ...
                <span className="text-[10px] font-black text-neutral-400 uppercase tracking-[0.2em]">Verified on SkateHubba</span>
              </div>
