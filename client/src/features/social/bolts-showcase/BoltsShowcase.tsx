...
export default function BoltsShowcase() {
  ...
  return (
    <div className="min-h-screen bg-[#0a0a0a] flex flex-col selection:bg-[#ff6a00]/30">
      <Navigation />
      
      <main className="flex-1 container mx-auto px-4 py-8 max-w-md animate-in fade-in slide-in-from-bottom-4 duration-700">
        <header className="text-center mb-10">
          <h1 className="text-5xl font-black text-white tracking-tighter uppercase mb-2" style={{ fontFamily: "'Bebas Neue', sans-serif" }}>
            Bolts Showcase
          </h1>
        ...
        {isLoading ? (
          <div className="flex flex-col items-center justify-center py-20 text-gray-400">
            ...
            <p className="text-xl font-medium tracking-tight" style={{ fontFamily: "'Bebas Neue', sans-serif" }}>Gathering the crew...</p>
          </div>
        ) : !skaters || skaters.length === 0 ? (
          <div className="text-center py-20 border-2 border-dashed border-neutral-900 rounded-3xl">
            <p className="text-neutral-700 font-black uppercase tracking-tighter text-2xl" style={{ fontFamily: "'Bebas Neue', sans-serif" }}>
              No bolts logged yet
            </p>
                  ...
                  <CardContent className="p-4 flex items-center justify-between">
                    <div className="flex items-center gap-4">
                      <div className="relative">
                        <div className="w-12 h-12 rounded-full bg-neutral-900 border-2 border-neutral-800 flex items-center justify-center overflow-hidden">
                          {skater.photoURL ? (
                            <img src={skater.photoURL} alt={skater.handle} className="w-full h-full object-cover" />
                          ) : (
                            <span className="text-neutral-700 font-black" style={{ fontFamily: "'Bebas Neue', sans-serif" }}>
                      ...
                      <div>
                        <div className="flex items-center gap-2">
                          <h3 className="text-white font-black text-lg tracking-tight leading-none" style={{ fontFamily: "'Bebas Neue', sans-serif" }}>
                            @{skater.handle}
                          </h3>
                        </div>
                        <div className="flex items-center gap-2 mt-1">
                          <Badge variant="outline" className="bg-neutral-950 border-neutral-800 text-[8px] font-bold uppercase tracking-widest py-0 px-1.5 opacity-60">
                            Verified Skater
                          </Badge>
                        </div>
                      </div>
                    ...
                    <div className="flex flex-col items-end">
                      <div className="flex items-center gap-1.5 bg-success/10 border border-success/20 px-3 py-1 rounded-lg">
                        ...
                        <span className="text-success font-black text-xl leading-none" style={{ fontFamily: "'Bebas Neue', sans-serif" }}>
