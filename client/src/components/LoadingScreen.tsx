...
export function LoadingScreen() {
  return (
    <div
      className="min-h-screen bg-[#181818] flex items-center justify-center p-4"
      role="status"
    ...
    >
      <div className="w-full max-w-md space-y-6 animate-in fade-in duration-300">
        ...
        {/* Loading indicator */}
        <div className="flex items-center justify-center gap-2 text-gray-400" aria-hidden="true">
...
export function PageLoadingSkeleton() {
  return (
    <div
      className="min-h-screen bg-[#181818] p-4"
      role="status"
