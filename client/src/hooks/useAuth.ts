...
export function useAuth() {
  ...
  const {
    ...
    useShallow((s) => ({
      ...
      backendDisplayName: s.backendDisplayName,
      roles: s.roles,
      loading: s.loading,
      ...
      sendPhoneVerification: s.sendPhoneVerification,
      confirmPhoneCode: s.confirmPhoneCode,
      phoneConfirmationResult: s.phoneConfirmationResult,
      signOut: s.signOut,
