      ...
      <div className="container mx-auto px-4 py-8">
        ...
        {error && (
          <div className="text-center py-16">
            ...
            <h3 className="text-xl font-semibold text-white mb-2">Shop Temporarily Unavailable</h3>
            <p className="text-gray-400 max-w-md mx-auto">
              We're experiencing technical difficulties loading the shop. Please try again in a moment.
            </p>
          </div>
        )}
